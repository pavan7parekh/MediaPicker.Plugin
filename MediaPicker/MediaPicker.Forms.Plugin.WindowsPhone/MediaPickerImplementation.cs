...
namespace MediaPicker.Forms.Plugin.WindowsPhone
{
    ...
    public class MediaPickerImplementation : IMediaPicker
    {
        ...
        public MediaPickerImplementation()
        {
            ...
            IsCameraAvailable = (Camera.IsCameraTypeSupported(CameraType.Primary) ||
        ...
        private void InternalOnPhotoChosen(object sender, PhotoResult photoResult)
        {
            ...
            if (saveImage)
            {
                ...
                {
                    path = options.GetUniqueMediaFileWithPath((options == null) ? "temp" : options.Directory,
                        p => store.FileExists(p));
